...
>***Yet ES6 imports fail to work in the client, when deployed to a browser.*** Moreover, said solutions require a
>lot of research, trial and error. I have explored solutions 4, 5, 6 and 7, with 7 looking the most promising. 
>None are ideal. Consequently, ***entity.ts***, located in >**src/client** and **src/server** is ***duplicate*** code.
